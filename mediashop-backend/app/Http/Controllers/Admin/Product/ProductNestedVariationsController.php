...
class ProductNestedVariationsController extends Controller
{
    /**
    ...
    {
        $product_variation_id = $request->product_variation_id;
        // Validate that a nested variation only exist a time for a product
        // And if exist doesn't allow add it again, only to edit it is allowed(for example: to edit its stock)
