                                                                                                                                ...
                                                                                                                                <td class="text-16 lh-26 c-black"
                                                                                                                                    ...
                                                                                                                                    <multiline>
                                                                                                                                        @if ($cart->product_variation)
                                                                                                                                            ...
                                                                                                                                            {{$cart->product_variation->property ? $cart->product_variation->property->name : $cart->product_variation->property->value_add}}
                                                                                                                                            @if ($cart->product_variation->variation_parent)
                                                                                                                                                <br />
                                                                                                                                                <strong>{{$cart->product_variation->variation_parent->attribute->name}}:</strong>
                                                                                                                                                {{$cart->product_variation->variation_parent->property ? $cart->product_variation->variation_parent->property->name : $cart->product_variation->variation_parent->property->value_add}}
