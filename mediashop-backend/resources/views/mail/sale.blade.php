                                                                                                                    ...
                                                                                                                    <table
                                                                                                                        ...
                                                                                                                        <tr>
                                                                                                                            <td class="text-16"
                                                                                                                                style="font-size:16px; line-height:20px; color:#6e6e6e; font-family:'PT Sans', Arial, sans-serif; text-align:left; min-width:auto !important;">
                                                                                                                                <multiline>
                                                                                                                                    {{ $sale->sale_addres->name . ' ' . $sale->sale_addres->surname }}
                                                                                                                                    <br />
                                                                                                                                    {{ $sale->sale_addres->street_address }}
                                                                                                                                    <br />
                                                                                                                                    {{ $sale->sale_addres->country_region }}
                                                                                                                                    <br />
                                                                                                                                    {{ $sale->sale_addres->postcode_zip }}
                                                                                                                                    <br />
                                                                                                                                    {{ $sale->sale_addres->phone }}
                                                                                                                                </multiline>
                                                                                                                            </td>
                                                                                                                        </tr>
                                                                                                                    </table>
                                                                                                                                ...
                                                                                                                                <td class="text-16 lh-26 c-black"
                                                                                                                                    ...
                                                                                                                                    <multiline>
                                                                                                                                        @if ($sale_detail->product_variation)
                                                                                                                                            ...
                                                                                                                                            {{$sale_detail->product_variation->property ? $sale_detail->product_variation->property->name : $sale_detail->product_variation->property->value_add}}
                                                                                                                                            @if ($sale_detail->product_variation->variation_parent)
                                                                                                                                                <br />
                                                                                                                                                <strong>{{$sale_detail->product_variation->variation_parent->attribute->name}}:</strong>
                                                                                                                                                {{$sale_detail->product_variation->variation_parent->property ? $sale_detail->product_variation->variation_parent->property->name : $sale_detail->product_variation->variation_parent->property->value_add}}
